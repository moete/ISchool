  ...
  })(
    {
        ...
        function(t, e, i) {
          ...
          function m(t) {
            ...
            return (
              ...
              (e =
                0.0031308 < (e = 3.2406 * a + -1.5372 * o + -0.4986 * r)
          ...
          function x(t) {
            ...
            return (
              (a =
                o <= 8
                  ? ((i = (100 * o) / 903.3) / 100) * 7.787 + 16 / 116
              ...
              (e.controllers.bar = e.DatasetController.extend({
                ...
                calculateBarIndexPixels: function(t, e, i) {
                  var n,
                    ...
                    C = Math.min(
                      S.valueOrDefault(y.maxBarThickness, 1 / 0),
                      k.chunk * k.ratio
                    );
                  return {
                    base: w - C / 2,
              ...
              t.controllers.bubble = t.DatasetController.extend({
                ...
                setHoverStyle: function(t) {
                  ...
                  (t.$previousStyle = {
                    ...
                    (e.backgroundColor = g.valueOrDefault(
                      i.hoverBackgroundColor,
                      g.getHoverColor(i.backgroundColor)
                    )),
                    (e.borderColor = g.valueOrDefault(
                      i.hoverBorderColor,
                      g.getHoverColor(i.borderColor)
                    )),
                    (e.borderWidth = g.valueOrDefault(
                      i.hoverBorderWidth,
                      i.borderWidth
                    )),
                    ...
                    ? u.labels.map(function(t, e) {
                        ...
                        return {
                          ...
                          fillStyle: o.backgroundColor
                            ? o.backgroundColor
                            : r(n.backgroundColor, e, s.backgroundColor),
                          strokeStyle: o.borderColor
                            ? o.borderColor
                            : r(n.borderColor, e, s.borderColor),
                          lineWidth: o.borderWidth
                            ? o.borderWidth
                            : r(n.borderWidth, e, s.borderWidth),
              ...
              t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend(
                {
                  ...
                  updateElement: function(t, e, i) {
                    ...
                    (v.backgroundColor = b.backgroundColor
                      ? b.backgroundColor
                      : x(h.backgroundColor, e, y.backgroundColor)),
                      (v.borderColor = b.borderColor
                        ? b.borderColor
                        : x(h.borderColor, e, y.borderColor)),
                      (v.borderWidth = b.borderWidth
                        ? b.borderWidth
                        : x(h.borderWidth, e, y.borderWidth)),
                      (i && s.animateRotate) ||
                        ((v.startAngle =
                          0 === e
                            ? r.rotation
                  ...
                  getMaxBorderWidth: function(t) {
                    for (
                      ...
                      n =
                        (n =
                          n < (e = t[r]._model ? t[r]._model.borderWidth : 0)
                            ? e
                            : n) <
                        (i = t[r]._chart
                          ? t[r]._chart.config.data.datasets[a].hoverBorderWidth
                          : 0)
                          ? i
                          : n;
                    return n;
            ...
            (e.exports = function(t) {
              ...
              t.controllers.line = t.DatasetController.extend({
                  ...
                  for (
                    h &&
                      ...
                      (r._model = {
                        ...
                        tension: n.tension
                          ? n.tension
                          : g.valueOrDefault(c.lineTension, u.tension),
                        ...
                        steppedLine: n.steppedLine
                          ? n.steppedLine
                          : g.valueOrDefault(c.steppedLine, u.stepped),
                ...
                getPointBorderColor: function(t, e) {
                  ...
                  return (
                    a.borderColor
                      ? (i = a.borderColor)
                      : n.pointBorderColor
                      ? (i = g.valueAtIndexOrDefault(n.pointBorderColor, e, i))
                ...
                getPointRotation: function(t, e) {
                  ...
                  return (
                    isNaN(a.rotation)
                      ? (isNaN(n.pointRotation) &&
                          !g.isArray(n.pointRotation)) ||
                        (i = g.valueAtIndexOrDefault(n.pointRotation, e, i))
                      : (i = a.rotation),
                    i
                  );
                },
                updateElement: function(t, e, i) {
                  ...
                  void 0 !== l.radius &&
                    ...
                    (t._model = {
                      ...
                      radius:
                        s.radius ||
                        g.valueAtIndexOrDefault(l.pointRadius, e, f.radius),
                      pointStyle:
                        s.pointStyle ||
                        g.valueAtIndexOrDefault(l.pointStyle, e, f.pointStyle),
                      ...
                      steppedLine:
                        !!r.dataset._model && r.dataset._model.steppedLine,
                      hitRadius:
                        s.hitRadius ||
                ...
                updateBezierControlPoints: function() {
                  ...
                  if (
                    ...
                    for (t = 0, e = r.length; t < e; ++t)
                      (i = r[t]._model),
                        (n = g.splineCurve(
                          g.previousItem(r, t)._model,
                          i,
                          g.nextItem(r, t)._model,
                  ...
                  if (this.chart.options.elements.line.capBezierPoints)
                    for (t = 0, e = r.length; t < e; ++t)
                      ((i = r[t]._model).controlPointPreviousX = s(
                        ...
                        (i.controlPointNextX = s(
                          i.controlPointNextX,
                          o.left,
                          o.right
                        )),
                        (i.controlPointNextY = s(
                          i.controlPointNextY,
                          o.top,
                          o.bottom
                        ));
                    ...
                    ? l.labels.map(function(t, e) {
                        ...
                        return {
                          ...
                          fillStyle: a.backgroundColor
                            ? a.backgroundColor
                            : o(n.backgroundColor, e, r.backgroundColor),
                          strokeStyle: a.borderColor
                            ? a.borderColor
                            : o(n.borderColor, e, r.borderColor),
                          lineWidth: a.borderWidth
                            ? a.borderWidth
                            : o(n.borderWidth, e, r.borderWidth),
                          hidden: isNaN(n.data[e]) || i.data[e].hidden,
                          index: e
                        };
                      })
              ...
              t.controllers.polarArea = t.DatasetController.extend({
                ...
                updateElement: function(t, e, i) {
                  ...
                  var v = this.chart.options.elements.arc,
                    ...
                    y = t._model;
                  (y.backgroundColor = b.backgroundColor
                    ? b.backgroundColor
                    : x(o.backgroundColor, e, v.backgroundColor)),
                    (y.borderColor = b.borderColor
                      ? b.borderColor
                      : x(o.borderColor, e, v.borderColor)),
                    (y.borderWidth = b.borderWidth
                      ? b.borderWidth
                      : x(o.borderWidth, e, v.borderWidth)),
                    t.pivot();
                },
              ...
              t.controllers.radar = t.DatasetController.extend({
                  ...
                  void 0 !== r.tension &&
                    ...
                    u.extend(t.dataset, {
                      ...
                      _model: {
                        tension: o.tension
                          ? o.tension
                          : u.valueOrDefault(r.lineTension, s.tension),
                        ...
                        borderDashOffset: o.borderDashOffset
                          ? o.borderDashOffset
                          : r.borderDashOffset || s.borderDashOffset,
                        borderJoinStyle: o.borderJoinStyle
                          ? o.borderJoinStyle
                          : r.borderJoinStyle || s.borderJoinStyle
                      }
                    }),
                    t.dataset.pivot(),
                    u.each(
                  ...
                  void 0 !== o.radius &&
                    ...
                    u.extend(t, {
                      ...
                      _model: {
                        ...
                        radius: a.radius
                          ? a.radius
                          : u.valueAtIndexOrDefault(o.pointRadius, e, s.radius),
                        backgroundColor: a.backgroundColor
                          ? a.backgroundColor
                          : u.valueAtIndexOrDefault(
                ...
                updateBezierControlPoints: function() {
                  ...
                  u.each(o.data, function(t, e) {
                    var i = t._model,
                      n = u.splineCurve(
                        u.previousItem(o.data, e, !0)._model,
                        i,
                        u.nextItem(o.data, e, !0)._model,
                        i.tension
                      );
              ...
              h.extend(u.prototype, {
                construct: function(t, e) {
                  var i,
                    n,
                    a = this;
                  ((n = (i = (i = e) || {}).data = i.data || {}).datasets =
                    n.datasets || []),
                    (n.labels = n.labels || []),
                    (i.options = h.configMerge(
                      c.global,
                      c[i.type],
                      i.options || {}
                    )),
                ...
                resize: function(t) {
                  var e = this,
                    ...
                    r = Math.max(
                      0,
                      Math.floor(a ? o / a : h.getMaximumHeight(n))
                    );
                  if (
                ...
                updateDataset: function(t) {
                  var e = this.getDatasetMeta(t),
                    i = { meta: e, index: t };
                  !1 !== g.notify(this, "beforeDatasetUpdate", [i]) &&
                    (e.controller.update(),
                ...
                drawDataset: function(t, e) {
                  ...
                  !1 !== g.notify(this, "beforeDatasetDraw", [n]) &&
                    (i.controller.draw(e),
                ...
                _drawTooltip: function(t) {
                  ...
                  !1 !== g.notify(this, "beforeTooltipDraw", [i]) &&
                    (e.draw(), g.notify(this, "afterTooltipDraw", [i]));
                },
                  ...
                  e._data !== n &&
                    ...
                    (a = n)._chartjs
                      ...
                      : (Object.defineProperty(a, "_chartjs", {
                        ...
                        o.forEach(function(t) {
                          var i =
                              "onData" + t.charAt(0).toUpperCase() + t.slice(1),
                            n = a[t];
                ...
                setHoverStyle: function(t) {
                  ...
                  (t.$previousStyle = {
                    ...
                    (r.backgroundColor = n.hoverBackgroundColor
                      ? n.hoverBackgroundColor
                      : a(e.hoverBackgroundColor, i, o(r.backgroundColor))),
                    (r.borderColor = n.hoverBorderColor
                      ? n.hoverBorderColor
                      : a(e.hoverBorderColor, i, o(r.borderColor))),
                    (r.borderWidth = n.hoverBorderWidth
                      ? n.hoverBorderWidth
                      : a(e.hoverBorderWidth, i, r.borderWidth));
                },
        ...
        function(t, e, i) {
          ...
          n.extend(a.prototype, {
            ...
            pivot: function() {
              var t = this;
              return (
                t._view || (t._view = n.clone(t._model)), (t._start = {}), t
              );
            },
            transition: function(t) {
              var e = this,
        ...
        function(t, e, i) {
          ...
          e.exports = function() {
            ...
            function e(t, e, i) {
              ...
              return s || l
                ? Math.min(s ? d(o, t, i) : u, l ? d(r, a, i) : u)
                : "none";
            }
            (g.configMerge = function() {
                ...
                [].slice.call(arguments, 1),
                {
                  merger: function(t, e, i, n) {
                    var a = e[t] || {},
                      o = i[t];
                    "scales" === t
                      ? (e[t] = g.scaleMerge(a, o))
                      : "scale" === t
                      ? (e[t] = g.merge(a, [l.getScaleDefaults(o.type), o]))
                      : g._merger(t, e, i, n);
                  }
                }
              );
                        ...
                        for (e[t] || (e[t] = []), a = 0; a < s; ++a)
                          (r = i[t][a]),
                            ...
                            !e[t][a].type || (r.type && r.type !== e[t][a].type)
                              ? g.merge(e[t][a], [l.getScaleDefaults(o), r])
                              : g.merge(e[t][a], r);
              ...
              (g.getRelativePosition = function(t, e) {
                ...
                return {
                  x: (i = Math.round(
                    (((i - r.left - l) / h) * o.width) /
                      e.currentDevicePixelRatio
                  )),
                  y: (n = Math.round(
                    (((n - r.top - u) / f) * o.height) /
                      e.currentDevicePixelRatio
                  ))
                };
              }),
              ...
              (g._calculatePadding = function(t, e, i) {
                return -1 < (e = g.getStyle(t, e)).indexOf("%")
                  ? i / parseInt(e, 10)
                  : parseInt(e, 10);
              }),
              ...
              (g.getMaximumWidth = function(t) {
                ...
                var i = e.clientWidth,
                  n =
                    i -
                    g._calculatePadding(e, "padding-left", i) -
                    g._calculatePadding(e, "padding-right", i),
              ...
              (g.getMaximumHeight = function(t) {
                ...
                var i = e.clientHeight,
                  n =
                    i -
                    g._calculatePadding(e, "padding-top", i) -
                    g._calculatePadding(e, "padding-bottom", i),
              ...
              if (e) {
                ...
                B.each(u.concat(d, c, h), function(t) {
                  var e,
                    i = t.isHorizontal();
                  i
                    ? ((e = t.update(t.fullWidth ? g : x, b)), (y -= e.height))
                    : ((e = t.update(v, y)), (x -= e.width)),
                    k.push({ horizontal: i, minSize: e, box: t });
                });
                var M = 0,
                  w = 0,
                  C = 0,
                  ...
                  this._plugins.concat(i.plugins || []).forEach(function(t) {
                    if (-1 === n.indexOf(t)) {
                      var e = t.id,
                        i = o[e];
                      !1 !== i &&
                        (!0 === i && (i = s.clone(r.global.plugins[e])),
                        n.push(t),
      ...
      33: [
        function(t, e, i) {
          ...
          function C(t) {
            return H.options.toLineHeight(
              H.valueOrDefault(t.lineHeight, 1.2),
              H.valueOrDefault(t.fontSize, y.global.defaultFontSize)
            );
          }
          y._set("scale", {
            display: !0,
            ...
            (e.exports = n.extend({
              ...
              calculateTickRotation: function() {
                ...
                if (n.length && t.options.display && t.isHorizontal())
                  for (
                    var r,
                      s = H.longestText(e, a.font, n, t.longestTextCache),
                      l = s,
              ...
              fit: function() {
                ...
                if (a.display && s) {
                  ...
                  if (l) {
                    ...
                    0 !== t.labelRotation
                      ? ((t.paddingLeft =
                          "bottom" === n.position ? v * x + 3 : v * g + 3),
                        (t.paddingRight =
                          "bottom" === n.position ? v * g + 3 : v * y + 3))
                      : ((t.paddingLeft = x / 2 + 3),
              ...
              draw: function(S) {
                ...
                if (D.display) {
                  ...
                  if (
                    (H.each(O, function(t, e) {
                      if (!H.isNullOrUndef(t.label)) {
                        ...
                        o =
                          e === _.zeroLineIndex &&
                          D.offset === A.offsetGridLines
                            ? ((i = A.zeroLineWidth),
                              (n = A.zeroLineColor),
                              (a = A.zeroLineBorderDash),
                              A.zeroLineBorderDashOffset)
                    ...
                    H.each(z, function(t) {
                      if (
                        (A.display &&
                          ...
                          r.beginPath(),
                          A.drawTicks &&
                            (r.moveTo(t.tx1, t.ty1), r.lineTo(t.tx2, t.ty2)),
                          A.drawOnChartArea &&
                  ...
                  if (A.drawBorder) {
                    ...
                    F
                      ? ((v = b = "top" === D.position ? _.bottom : _.top),
                        (v += x),
                        (b += x))
                      : ((p = m = "left" === D.position ? _.right : _.left),
                        (p += x),
                        (m += x)),
                      r.beginPath(),
                      r.moveTo(p, v),
      ...
      36: [
        function(t, e, i) {
          ...
          function r(t, e) {
            return (
              e &&
                (R.isArray(e) ? Array.prototype.push.apply(t, e) : t.push(e)),
              t
            );
          }
          function s(t) {
            ...
            update: function(t) {
              ...
              if (S.length) {
                ...
                M.filter &&
                  ...
                  R.each(O, function(t) {
                    T.push(M.callbacks.labelColor.call(k, t, k._chart)),
                  ...
                  "right" === h
                    ? (s -= a.width)
                    : "center" === h &&
                      ((s -= a.width / 2) + a.width > r.width &&
                        (s = r.width - a.width),
                      s < 0 && (s = 0)),
                  "top" === f
                    ? (l += g)
                    : (l -= "bottom" === f ? a.height + g : a.height / 2),
                  "center" === f
                    ? "left" === h
                      ? (s += g)
                      : "right" === h && (s -= g)
            ...
            getCaretPosition: function(t, e, i) {
              ...
              if ("center" === h)
                (s = g + m / 2),
                  (l =
                    "left" === c
                      ? ((a = (n = f) - u), (o = n), (r = s + u), s - u)
                      : ((a = (n = f + p) + u), (o = n), (r = s - u), s + u));
              else if (
                ((o =
                  ((n =
                    "left" === c
            ...
            drawTitle: function(t, e, i, n) {
              ...
              if (a.length) {
                ...
                var o,
                  ...
                  l = e.titleSpacing;
                for (
                  i.fillStyle = h(e.titleFontColor, n),
                    i.font = R.fontString(
                      s,
                      e._titleFontStyle,
                      e._titleFontFamily
              ...
              draw: function() {
                ...
                for (
                  this._loop && s.length && s.push(s[0]),
                    ...
                    o.setLineDash &&
                      o.setLineDash(a.borderDash || l.borderDash),
                    ...
                    0 === t
                      ...
                      : ((i = -1 === u ? i : s[u]),
                        n.skip ||
                          ((u !== t - 1 && !r) || -1 === u
                            ? o.moveTo(n.x, n.y)
                            : d.canvas.lineTo(o, i._view, e._view),
                          (u = t)));
                o.stroke(), o.restore();
              }
            }));
              ...
              draw: function(t) {
                ...
                e.skip ||
                  ((void 0 === t ||
                    ...
                    (n.lineWidth = d.valueOrDefault(
                      e.borderWidth,
                      u.global.elements.point.borderWidth
                    )),
                ...
                if (
                  ((r = l.horizontal
                    ? ((t = l.base),
                      ...
                      (a = t < e ? 1 : -1),
                      (o = 1),
                      l.borderSkipped || "left")
                    : ((t = l.x - l.width / 2),
                      (e = l.x + l.width / 2),
                      (a = 1),
                      (o = (i = l.y) < (n = l.base) ? 1 : -1),
                      l.borderSkipped || "bottom")),
                  u)
                ) {
          ...
          var n,
            d = {
              ...
              _mergerIf: function(t, e, i) {
                var n = e[t],
                  a = i[t];
                d.isObject(n) && d.isObject(a)
                  ? d.mergeIf(n, a)
                  : e.hasOwnProperty(t) || (e[t] = d.clone(a));
              },
            ...
            addEventListener: function(o, t, r) {
              ...
              if ("resize" !== t) {
                ...
                x(
                  e,
                  t,
                  ((i.proxies || (i.proxies = {}))[o.id + "_" + t] = function(
                    t
                  ) {
                    var e, i, n, a;
                    r(
                  ...
                  (function(t, e, i, n, a, o) {
                    ...
                    for (t.beginPath(), r = 0, s = f + !!o; r < s; ++r)
                      (d = i((u = e[(l = r % f)]._view), l, n)),
                        ...
                        (h = x(d)),
                        c && h
                          ? ((v = p.push(u)), (b = m.push(d)))
                          : v &&
                            b &&
                            (g
                              ? (c && p.push(u), h && m.push(d))
                              : (y(t, p, m, v, b),
                                (v = b = 0),
                                (p = []),
                                (m = [])));
        ...
        function(t, e, i) {
          ...
          var r = n.extend({
            ...
            fit: function() {
              ...
              if (
                ((h.height = f
                  ? ((h.width = n.maxWidth), e ? 10 : 0)
                  : ((h.width = e ? 10 : 0), n.maxHeight)),
                e)
              )
                if (((o.font = d), f)) {
            ...
            draw: function() {
              ...
              if (h.display) {
                ...
                b = C
                  ...
                  : { x: c.left + f.padding, y: c.top + f.padding, line: 0 };
                var S = k + f.padding;
                D.each(c.legendItems, function(t, e) {
                  ...
                  C
                    ? m <= u + l &&
                      ((d = b.y += S),
                      b.line++,
                      (u = b.x = c.left + (m - v[b.line]) / 2))
                    : d + S > c.bottom &&
                      ((u = b.x = u + c.columnWidths[b.line] + f.padding),
                    ...
                    (function(t, e, i) {
                      if (!(isNaN(M) || M <= 0)) {
                        ...
                        if (
                          (x.setLineDash &&
                            x.setLineDash(y(i.lineDash, p.borderDash)),
                          ...
                          n || x.strokeRect(t, e, M, k), x.fillRect(t, e, M, k);
                        x.restore();
                      }
                    })(u, d, t),
                    (w[e].left = u),
          ...
          e.exports = {
            ...
            beforeUpdate: function(t) {
              var e = t.options.legend,
                i = t.legend;
              e
                ? (D.mergeIf(e, _.global.legend),
                  i ? (a.configure(t, i, e), (i.options = e)) : s(t, e))
                : i && (a.removeBox(t, i), delete t.legend);
            },
        ...
        function(t, e, i) {
          ...
          var r = n.extend({
            ...
            fit: function() {
              ...
              t.isHorizontal()
                ? ((o.width = t.maxWidth), (o.height = l))
                : ((o.width = l), (o.height = t.maxHeight)),
                (t.width = o.width),
                (t.height = o.height);
            },
            afterFit: o,
          ...
          e.exports = {
            ...
            beforeUpdate: function(t) {
              var e = t.options.title,
                i = t.titleBlock;
              e
                ? (w.mergeIf(e, M.global.title),
                  i ? (a.configure(t, i, e), (i.options = e)) : s(t, e))
                : i && (a.removeBox(t, i), delete t.titleBlock);
            }
          };
        },
        { 26: 26, 27: 27, 31: 31, 46: 46 }
                  ...
                  if (
                    ...
                    c.each(t, function(t, e) {
                      var n = l.getDatasetMeta(e),
                        i = [
                          n.type,
                          void 0 === s.stacked && void 0 === n.stack ? e : "",
                          n.stack
                        ].join(".");
                      void 0 === d[i] &&
                        (d[i] = { positiveValues: [], negativeValues: [] });
                  ...
                  a = (t.ticks = (function(t, e) {
                    ...
                    if (t.stepSize && 0 < t.stepSize) a = t.stepSize;
                      ...
                      (a = c.niceNum(r / (t.maxTicks - 1), !0)),
                        void 0 !== (n = t.precision) &&
                          ((i = Math.pow(10, n)), (a = Math.ceil(a * i) / i));
                    }
                    var s = Math.floor(e.min / a) * a,
                      l = Math.ceil(e.max / a) * a;
                    c.isNullOrUndef(t.min) ||
                      c.isNullOrUndef(t.max) ||
                      !t.stepSize ||
                      (c.almostWhole((t.max - t.min) / t.stepSize, a / 1e3) &&
                        ((s = t.min), (l = t.max)));
                    var u = (l - s) / a;
                    (u = c.almostEquals(u, Math.round(u), a / 1e3)
                      ? Math.round(u)
                      : Math.ceil(u)),
                      a < (n = 1) &&
                        ((n = Math.pow(10, 1 - Math.floor(c.log10(a)))),
                        (s = Math.round(s * n) / n),
                        (l = Math.round(l * n) / n)),
            ...
            var t = {
              ...
              e = n.extend({
                  ...
                  if (
                    ...
                    h.each(t, function(t, e) {
                      var a = s.getDatasetMeta(e),
                        o = [
                          a.type,
                          void 0 === i.stacked && void 0 === a.stack ? e : "",
                          a.stack
                        ].join(".");
                      s.isDatasetVisible(e) &&
                        l(a) &&
                  ...
                  (t.min = i(e.min, t.min)),
                    ...
                    t.min === t.max &&
                      (0 !== t.min && null !== t.min
                        ? ((t.min = Math.pow(
                            10,
                            Math.floor(h.log10(t.min)) - 1
                          )),
                          (t.max = Math.pow(
                            10,
                            Math.floor(h.log10(t.max)) + 1
                          )))
                        : ((t.min = 1), (t.max = 10))),
                    null === t.min &&
                      (t.min = Math.pow(10, Math.floor(h.log10(t.max)) - 1)),
                    null === t.max &&
                      (t.max =
                        0 !== t.min
                          ? Math.pow(10, Math.floor(h.log10(t.min)) + 1)
                          : 10),
                    null === t.minNotZero &&
                      (0 < t.min
                        ? (t.minNotZero = t.min)
                ...
                buildTicks: function() {
                  var t = this,
                    ...
                    a = (t.ticks = (function(t, e) {
                      ...
                      0 === r
                        ? ((i = Math.floor(h.log10(e.minNotZero))),
                          (n = Math.floor(e.minNotZero / Math.pow(10, i))),
                          a.push(r),
                          (r = n * Math.pow(10, i)))
                        : ((i = Math.floor(h.log10(r))),
                ...
                getPixelForValue: function(t) {
                  ...
                  return (
                    ...
                    (o = s
                      ...
                      : ((n = r.start), (a = r.end), 1)),
                    (i = r.isHorizontal()
                      ? ((e = r.width), s ? r.right : r.left)
                      : ((e = r.height), (o *= -1), s ? r.top : r.bottom)),
                    t !== n &&
                      (0 === n &&
                        ((e -= d = h.getValueOrDefault(
                ...
                getValueForPixel: function(t) {
                  ...
                  if (
                    ((n = r ? ((i = o.end), o.start) : ((i = o.start), o.end)),
                    (a = o.isHorizontal()
                      ? ((e = o.width), r ? o.right - t : t - o.left)
                      : ((e = o.height), r ? t - o.top : o.bottom - t)) !== i)
                  ) {
                    if (0 === i) {
                      var u = h.getValueOrDefault(
                        o.options.ticks.fontSize,
                        c.defaults.global.defaultFontSize
                      );
                      (a -= u), (e -= u), (i = l);
                    }
                      ...
                      for (e = 0; e < c; e++) {
                        (n = t.getPointPosition(e, o)),
                          ...
                          (i = k.isArray(d)
                            ...
                            : { w: l.measureText(d).width, h: u }),
                          (t._pointLabelSizes[e] = i);
                        var h = t.getIndexAngle(e),
                          f = k.toDegrees(h) % 360,
                          g = m(f, n.x, i.w, 0, 180),
                          p = m(f, n.y, i.h, 90, 270);
                        g.start < r.l && ((r.l = g.start), (s.l = h)),
                          g.end > r.r && ((r.r = g.end), (s.r = h)),
                          p.start < r.t && ((r.t = p.start), (s.t = h)),
                          p.end > r.b && ((r.b = p.end), (s.b = h));
                      }
              ...
              draw: function() {
                ...
                if (t.display) {
                  ...
                  k.each(o.ticks, function(t, e) {
                    if (0 < e || s.reverse) {
                      var i = o.getDistanceFromCenterForValue(
                        o.ticksAsNumbers[e]
                      );
                      if (
                        (r.display &&
                          ...
                          (function(t, e, i, n) {
                            var a = t.ctx;
                            if (
                              ((a.strokeStyle = k.valueAtIndexOrDefault(
                                e.color,
                                n - 1
                              )),
                              (a.lineWidth = k.valueAtIndexOrDefault(
                                e.lineWidth,
                                n - 1
                              )),
                        ...
                        if (
                          ...
                          (u.fillStyle = s.backdropColor),
                            u.fillRect(
                              -a / 2 - s.backdropPaddingX,
                              -i - c / 2 - s.backdropPaddingY,
                              a + 2 * s.backdropPaddingX,
                              c + 2 * s.backdropPaddingY
                            );
                        }
                        (u.textAlign = "center"),
                    ...
                    (t.angleLines.display || t.pointLabels.display) &&
                      (function(t) {
                        ...
                        var o,
                          ...
                          s,
                          l,
                          u = t.getDistanceFromCenterForValue(
            ...
            for (
              l ||
                ...
                d &&
                  ...
                  !u &&
                  !o.round &&
                  (a.startOf(s), a.add(~~((h - a) / (c.size * l)) * l, r));
              a < f;
              a.add(l, r)
            )
              g.push(+a);
          ...
          e.exports = function() {
            var t = n.extend({
                  ...
                  (h._unit =
                    ...
                    (function(t, e, i, n) {
                      ...
                      for (a = k.length - 1; a >= k.indexOf(e); a--)
                        if (((o = k[a]), y[o].common && r.as(o) >= t.length))
                          return o;
              ...
              getLabelForIndex: function(t, e) {
                ...
                return (
                  m.isObject(o) && (a = this.getRightValue(o)),
                  n.tooltipFormat
                    ? C(a, n).format(n.tooltipFormat)
                    : "string" == typeof a
                    ? a
                    : C(a, n).format(this._labelFormat)
                );
              },
              ...
              getLabelWidth: function(t) {
                ...
                return (
                  i * a +
                  m.valueOrDefault(e.fontSize, r.global.defaultFontSize) * o
                );
              },
